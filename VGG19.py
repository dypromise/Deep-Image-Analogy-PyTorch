"""
This code is modified from harveyslash's work
...
class VGG19:
    def __init__(self, device):
        ...
        # the new Feature extractor module network
    ...
    def get_deconvoluted_feat(self, feat, curr_layer, init=None, lr=10,
                              iters=13, display=False):
        ...
        print('\tstate:'+stat)
        print(
            '\tend_loss/init_loss: {:.2f}/{:.2f}'.format(end_loss, init_loss))
    ...
    def get_deconvoluted_feat_v2(self, feat, curr_layer, init=None,
                                 lr=10, iters=13, display=False,
        ...
        while run[0] <= iters:
            ...
            def closure():
                ...
                run[0] += 1
                if run[0] % 20 == 0:
                    print('Run : {}\tLoss : {:4f}'.format(run[0], loss))
